...
(check-equal? (eval (cond ((assoc 'a '((a 1) (b 2))) => cadr) (else #f)) the-global-environment) 1)
(check-equal? (eval (cond ((assoc 'b '((a 1) (b 2 3))) => caddr) (else #f)) the-global-environment) 3)
