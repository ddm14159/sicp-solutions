...
(check-equal? (let->combination '(let ((a 5)) (+ a a))) '((lambda (a) (+ a a)) (5)))

(check-equal? (let->combination '(let ((a (car (list 2 3 5)))
                         (b (cadr (list 2 3 5))))
                                   (+ a b))) '((lambda (a b) (+ a b)) ((car (list 2 3 5)) (cadr (list 2 3 5)))))
